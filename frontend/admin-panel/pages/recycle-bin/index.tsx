...
const RecycleBin = () => {
    ...
    return (
       <>
           <Head>
               <title>Recycle Bin Dashboard • Xaqsoor</title>
               <meta name="description" content="Manage deleted users, announcements, media, donations, and more from the recycle bin dashboard." />
           </Head>
